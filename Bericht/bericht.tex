...
\include{./Kapitel/abk}              % Abkürzungsverzeichnis
\setcounter{roman-numbering}{\value{page}}
\pagenumbering{arabic}
\include{./Kapitel/Kapitel1_Einleitung}
\include{./Kapitel/Kapitel2_Stand_der_Technik}
\include{./Kapitel/Kapitel3_Konzept}
\include{./Kapitel/Kapitel4_Implementierung}
\include{./Kapitel/Kapitel5_Fazit}
