...
\lstinputlisting[language=c++, style=algoBericht, label={arduino_example}, captionpos=b, caption={Aufbau eines Arduino-Programms}]{./Listings/example.ino}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.8\textwidth]{./img/Bilder_Stand_der_Technik/pwm.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{./img/Bilder_Stand_der_Technik/nextion_editor_overview.png}}
...
\lstinputlisting[language=c++, style=algoBericht, label={nextion_example}, captionpos=b, caption={Beispielprogramm mit Nextion}, escapeinside={//*}{*)}]{./Listings/nextion.ino}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[height=0.5\linewidth]{./img/Bilder_Stand_der_Technik/nextion_example.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.8\textwidth]{./img/Bilder_Stand_der_Technik/pinout_raspberry.png}}
