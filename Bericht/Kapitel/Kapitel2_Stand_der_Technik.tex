...
\subsection{Ansätze für die Erstellung eines Chatbots}
...
\begin{itemize}
    ...
    \item Restricted Boltzmann Machines (RBM) - Markov-Ketten, die so trainiert werden, dass sie die "Energie"-Funktion minimieren;
