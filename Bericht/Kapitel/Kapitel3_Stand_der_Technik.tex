...
\end{itemize}
Jede dieser Methoden kann entweder allein oder als Teil einer NLP-Pipeline angewendet werden. 
...
Bei diesem Ansatz wird das Histogramm der Wörter im Text betrachtet, d. h. wir betrachten jedes Wort als ein Merkal.
(QELLE Neural Network Methods in Natural Language 
Processing (Synthesis Lectures on Human Language Technologies https://
www.amazon.com/Language-Processing-Synthesis-Lectures-Technologies/dp/
1627052984/ref=as\_li\_ss\_tl?ie=UTF8\&qid=1502062931\&sr=8-
1\&keywords=Neural+Network+Methods+in+Natural+Language+Processing\&linkCod
e=sl1\&tag=inspiredalgor-20\&linkId=d63df073fea3ebe2d405820570b3ff03))\\\\
...
Enthält das Wörterbuch beispielsweise 1000 Wörter, dann hat jeder unitäre Vektor eine Dimension von 1000, und die Komponente, die der Position des Wortes im Wörterbuch entspricht, ist gleich 1.
Zum Beispiel, der unitäre Vektor für den Satz \glqq Mojito ist ein leckerer Cocktail\grqq{} (nach dem Tokenisierungsprozess) sieht so aus:
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.6\textwidth]{Bilder_Kapitel_2/unitaerer_vektor.png}}
